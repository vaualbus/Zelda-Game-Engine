...
namespace ZeldaEngine.Tests
{
    ...
    {
        private static readonly Config TestConfig = new Config(new GameScriptConfig(AppDomain.CurrentDomain.BaseDirectory, AppDomain.CurrentDomain.BaseDirectory), null);
