    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            else
            {
                ...
                gameConfig = new GameConfig("Zelda Editor", 300, 200, AppDomain.CurrentDomain.BaseDirectory);
                ConfigurationManager.CreateConfiguration(gameConfig);
            }

            using (var app = new SharpDxCoreEngine(new ZeldaEditor(), gameConfig, new GameLogger(gameConfig)))
                app.Run();
        }
    }
}