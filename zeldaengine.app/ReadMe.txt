========================================================================
    APPLICAZIONE WIN32: cenni preliminari sul progetto ZeldaEngine.App
========================================================================

La creazione guidata applicazione ha creato questa applicazione ZeldaEngine.App.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione ZeldaEngine.App.


ZeldaEngine.App.vcxproj
...
ZeldaEngine.App.vcxproj.filters
...
ZeldaEngine.App.ico
    File di icona utilizzato come icona dell'applicazione (32x32). Tale icona è inclusa dal file di risorse principale ZeldaEngine.App.rc.

small.ico
    File di icona contenente una versione di dimensioni inferiori (16x16) dell'icona dell'applicazione. Tale icona è inclusa dal file di risorse principale ZeldaEngine.App.rc.

/////////////////////////////////////////////////////////////////////////////
Altri file standard:

StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato ZeldaEngine.App.pch e il file dei tipi precompilato StdAfx.obj.
