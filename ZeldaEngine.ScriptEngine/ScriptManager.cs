...
namespace ZeldaEngine.ScriptEngine
{
    public class ScriptManager : IScriptManager
    {
        ...
        {
            engine.Report("Init script Manager", ReportReason.Log);
        ...
        public object GetScriptValue(string scriptName, string propName)
        {
            ...
            try
            {
                ...
                return prop.GetValue(_scriptCachedInstances[script.ScriptType], null);
            }
            catch (Exception)
            {
        ...
        public void SetScriptFields(string scriptName, string fieldName, object value)
        {
            var script = FindAndCheck(scriptName);
            if (script == null)
                return;
